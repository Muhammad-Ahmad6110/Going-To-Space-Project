...
export default function Home() {
  const REACT_APP_CONTRACT_ADDRESS =
    "0x3C0b568512cDf758833386e1Ac74322185905cE0";
      ...
      <div className="container-fluid  ">
        ...
        <div className="row hy  px-2 justify-content-center">
          <div className="col-12 col-md-4">
            ...
            <br />
            {walletConnected ? (
              <button onClick={loadweb3} className="Mint-button trans3">
                MINT
              </button>
            ) : (
              <button onClick={connectWallet} className="Mint-button trans3">
                CONNECT
              </button>
            )}
          </div>
