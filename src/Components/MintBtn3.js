...
export default function Home() {
  const REACT_APP_CONTRACT_ADDRESS =
    "0x403ed51aCB0387CFd9111BE93A251c193CCb0477";
      ...
      <div className="container-fluid  ">
        ...
        <div className="row hy  px-2 justify-content-center">
          <div className="col-12 col-md-4 ">
            ...
            <br />
            {walletConnected ? (
              <button onClick={loadweb3} className="Mint-button trans2">
                MINT
              </button>
            ) : (
              <button onClick={connectWallet} className="Mint-button trans2">
                CONNECT
              </button>
            )}
          </div>
